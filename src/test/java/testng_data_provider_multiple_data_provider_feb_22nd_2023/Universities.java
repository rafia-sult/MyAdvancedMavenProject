...
public class Universities {
	...
	@Test(priority = 1, dataProvider = "ninjaDataSupplier", dataProviderClass = DataProviderDataSupply.class)
	...
	@Test(priority = 2, dataProvider = "rediffDataSupplier", dataProviderClass = DataProviderDataSupply.class)
	public static void rediffTest(String username, String password) {
		...
		softassert.assertTrue(driver.findElement(By.cssSelector("input.signinbtn")).isDisplayed());
		softassert.assertAll();
		driver.quit();
